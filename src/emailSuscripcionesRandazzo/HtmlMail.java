package emailSuscripcionesRandazzo;
...
public class HtmlMail {
	...
	*/	
	...
	{
	String pathname= "E:/emailSuscripcionRandazzo/codigo.html"; //RUTA DEL HTML
	String content = "";
	File f = null;
	...
	try
	{
		...
		while ((str = in.readLine()) != null) {
			...
			if (str.contains("mes")){ str="Nos ponemos en contacto para invitarte a licitar tu Plan Chevrolet. Se aceptar&aacute;n ofertas hasta el d&iacute;a 5 " + month + " en cualquiera de nuestras sucursales. ";}//agrega el mes
			content = content + str;
		}
		in.close();
		return content;
